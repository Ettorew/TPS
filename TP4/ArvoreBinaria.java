...
class Arvore{
    ...
    private void inserirRecursivo(No atual, No novo) {
        if(novo.nome.compareTo(atual.nome) < 0){
            if(atual.esq == null){
                ...
                inserirRecursivo(atual.esq, novo);
            }
        }else{
            if(atual.dir == null){
                atual.dir = novo;
            }else{
                inserirRecursivo(atual.dir, novo);
            }
        }
    }
    ...
    private boolean pesquisarRecursivo(No atual, String titulo) {
        ...
        if(titulo.equals(atual.nome)){
            return true;
        }else if(titulo.compareTo(atual.nome) < 0){
            comparacoes++;
...
public class ArvoreBinaria {
    public static void main(String args[]) throws FileNotFoundException, IOException {
        ...
        FileWriter fw = new FileWriter("832722_arvoreBinaria.txt");
