...
// Criar lista
ListaSequencial *criarLista(int tam) {
    ListaSequencial *lista = (ListaSequencial *)malloc(sizeof(ListaSequencial));
    lista->array = (Show **)malloc(tam * sizeof(Show *));
...
void inserir(ListaSequencial *lista, int pos, Show *s) {
...
// Tamanho da lista
int getN(ListaSequencial *lista) {
    return lista->n;
}
...
int main() {
    ...
    ListaSequencial *lista = criarLista(1368);
    char entrada[20];
    scanf("%s", entrada);
